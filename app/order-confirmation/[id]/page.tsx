    ...
    <div className="flex min-h-screen flex-col">
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-green-700">
                        <p>
                          You've earned {Math.floor(order.total / 50)} points
                          from this purchase! Points will be added to your
                          account once your order is delivered.
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      <footer className="border-t bg-muted/40">
        <div className="container py-6 text-center text-sm text-muted-foreground">
          <p>© 2024 Shubh_Farmers Market. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
