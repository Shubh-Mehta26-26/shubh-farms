...
export function LoyaltyCard({ user, loyaltyInfo }: LoyaltyCardProps) {
  ...
  return (
    <div
      ...
      role="button"
      aria-label={
        flipped ? "Show front of loyalty card" : "Show back of loyalty card"
      }
    >
      <div
          ...
          <div className="flex h-full flex-col justify-between">
            <div>
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-bold">Shubh_Farmers Market</h3>
        ...
        <div className="absolute h-full w-full rotate-y-180 backface-hidden rounded-xl bg-gradient-to-br from-green-700 to-green-900 p-6 text-white shadow-xl">
          <div className="flex h-full flex-col justify-between">
            ...
            <p className="text-center text-xs text-green-100">
              Tap card to flip • Present this card at checkout to earn and
              redeem points
            </p>
          </div>
        </div>
